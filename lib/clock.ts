 ...
 */
export function isGameLocked(kickoffTimeIso: string | Date, effectiveNow: Date): boolean {
 ...
 */
export function generateDynamicPresets(kickoffTimes: (string | Date)[]): DynamicPreset[] {
